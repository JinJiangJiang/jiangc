...
import com.jiang.util.FastDFSClient;
import com.jiang.util.FileUtils;
import com.jiang.util.IMoocJSONResult;
import com.jiang.util.MD5Utils;
...
public class UserController {
	...
	public IMoocJSONResult registOrLogin(@RequestBody Users user) throws Exception {
		...
		boolean usernameIsExist = userService.queryUsernameIsExist(user);
